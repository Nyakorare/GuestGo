  ...
  return `
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 md:py-12 animate-fade-in">
      ...
      <div class="mb-8 sm:mb-12 md:mb-16">
        ...
        <div class="max-w-4xl mx-auto px-2">
          <div class="space-y-4 sm:space-y-6 md:space-y-8">
            <div class="timeline-item flex flex-col sm:flex-row items-center gap-4 sm:gap-6 p-4 sm:p-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
              <div class="flex-shrink-0">
                <div class="w-10 h-10 sm:w-12 sm:h-12 bg-blue-600 rounded-full border-4 border-white dark:border-gray-900 flex items-center justify-center">
                  <span class="text-white font-bold text-xs sm:text-sm">2020</span>
                </div>
              </div>
              <div class="flex-1 text-center sm:text-left">
                <h3 class="text-lg sm:text-xl font-bold text-gray-900 dark:text-white mb-2">Company Founded</h3>
                <p class="text-sm sm:text-base text-gray-600 dark:text-gray-300">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
              </div>
            </div>
            <div class="timeline-item flex flex-col sm:flex-row items-center gap-4 sm:gap-6 p-4 sm:p-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
              <div class="flex-shrink-0">
                <div class="w-10 h-10 sm:w-12 sm:h-12 bg-green-600 rounded-full border-4 border-white dark:border-gray-900 flex items-center justify-center">
                  <span class="text-white font-bold text-xs sm:text-sm">2021</span>
                </div>
              </div>
              <div class="flex-1 text-center sm:text-left">
                <h3 class="text-lg sm:text-xl font-bold text-gray-900 dark:text-white mb-2">First Product Launch</h3>
                <p class="text-sm sm:text-base text-gray-600 dark:text-gray-300">Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
              </div>
            </div>
            <div class="timeline-item flex flex-col sm:flex-row items-center gap-4 sm:gap-6 p-4 sm:p-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
              <div class="flex-shrink-0">
                <div class="w-10 h-10 sm:w-12 sm:h-12 bg-purple-600 rounded-full border-4 border-white dark:border-gray-900 flex items-center justify-center">
                  <span class="text-white font-bold text-xs sm:text-sm">2022</span>
                </div>
              </div>
              <div class="flex-1 text-center sm:text-left">
                <h3 class="text-lg sm:text-xl font-bold text-gray-900 dark:text-white mb-2">Series A Funding</h3>
                <p class="text-sm sm:text-base text-gray-600 dark:text-gray-300">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p>
              </div>
            </div>
            <div class="timeline-item flex flex-col sm:flex-row items-center gap-4 sm:gap-6 p-4 sm:p-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
              <div class="flex-shrink-0">
                <div class="w-10 h-10 sm:w-12 sm:h-12 bg-orange-600 rounded-full border-4 border-white dark:border-gray-900 flex items-center justify-center">
                  <span class="text-white font-bold text-xs sm:text-sm">2023</span>
                </div>
              </div>
              <div class="flex-1 text-center sm:text-left">
                <h3 class="text-lg sm:text-xl font-bold text-gray-900 dark:text-white mb-2">International Expansion</h3>
                <p class="text-sm sm:text-base text-gray-600 dark:text-gray-300">Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
              </div>
            </div>
            <div class="timeline-item flex flex-col sm:flex-row items-center gap-4 sm:gap-6 p-4 sm:p-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
              <div class="flex-shrink-0">
                <div class="w-10 h-10 sm:w-12 sm:h-12 bg-red-600 rounded-full border-4 border-white dark:border-gray-900 flex items-center justify-center">
                  <span class="text-white font-bold text-xs sm:text-sm">2024</span>
                </div>
              </div>
              <div class="flex-1 text-center sm:text-left">
                <h3 class="text-lg sm:text-xl font-bold text-gray-900 dark:text-white mb-2">AI Integration</h3>
                <p class="text-sm sm:text-base text-gray-600 dark:text-gray-300">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="mb-8 sm:mb-12 md:mb-20 mt-4 sm:mt-6 md:mt-8">
        <h2 class="text-xl sm:text-2xl font-bold mb-4 sm:mb-6 md:mb-8 text-center animate-fade-in-up px-2" style="animation-delay:2.6s;">Our Values</h2>
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 px-2">
          <div class="value-card group bg-white dark:bg-gray-800 rounded-lg shadow-lg p-4 sm:p-6 text-center hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-300 ease-out cursor-pointer">
            <div class="w-12 h-12 sm:w-16 sm:h-16 bg-blue-100 dark:bg-blue-900 rounded-full mx-auto mb-3 sm:mb-4 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
            ...
            <h3 class="text-base sm:text-lg font-semibold text-gray-900 dark:text-white mb-2 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors duration-300">Excellence</h3>
            <p class="text-gray-600 dark:text-gray-300 text-xs sm:text-sm">We strive for the highest quality in everything we do.</p>
          </div>
          <div class="value-card group bg-white dark:bg-gray-800 rounded-lg shadow-lg p-4 sm:p-6 text-center hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-300 ease-out cursor-pointer">
            <div class="w-12 h-12 sm:w-16 sm:h-16 bg-green-100 dark:bg-green-900 rounded-full mx-auto mb-3 sm:mb-4 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
            ...
            <h3 class="text-base sm:text-lg font-semibold text-gray-900 dark:text-white mb-2 group-hover:text-green-600 dark:group-hover:text-green-400 transition-colors duration-300">Innovation</h3>
            <p class="text-gray-600 dark:text-gray-300 text-xs sm:text-sm">We constantly push boundaries to create better solutions.</p>
          </div>
          <div class="value-card group bg-white dark:bg-gray-800 rounded-lg shadow-lg p-4 sm:p-6 text-center hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-300 ease-out cursor-pointer">
            <div class="w-12 h-12 sm:w-16 sm:h-16 bg-purple-100 dark:bg-purple-900 rounded-full mx-auto mb-3 sm:mb-4 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
            ...
            <h3 class="text-base sm:text-lg font-semibold text-gray-900 dark:text-white mb-2 group-hover:text-purple-600 dark:group-hover:text-purple-400 transition-colors duration-300">Collaboration</h3>
            <p class="text-gray-600 dark:text-gray-300 text-xs sm:text-sm">We believe in the power of working together.</p>
          </div>
          <div class="value-card group bg-white dark:bg-gray-800 rounded-lg shadow-lg p-4 sm:p-6 text-center hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-300 ease-out cursor-pointer">
            <div class="w-12 h-12 sm:w-16 sm:h-16 bg-orange-100 dark:bg-orange-900 rounded-full mx-auto mb-3 sm:mb-4 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
            ...
            <h3 class="text-base sm:text-lg font-semibold text-gray-900 dark:text-white mb-2 group-hover:text-orange-600 dark:group-hover:text-orange-400 transition-colors duration-300">Passion</h3>
            <p class="text-gray-600 dark:text-gray-300 text-xs sm:text-sm">We are passionate about solving real-world problems.</p>
          </div>
        </div>
      </div>
      ...
      <div class="mb-8 sm:mb-12 md:mb-20 mt-4 sm:mt-6 md:mt-8">
        <h2 class="text-xl sm:text-2xl font-bold mb-4 sm:mb-6 md:mb-8 text-center animate-fade-in-up px-2" style="animation-delay:2.8s;">Technology Stack</h2>
        <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-3 sm:gap-4 md:gap-6 px-2">
          <div class="tech-item group bg-white dark:bg-gray-800 rounded-lg shadow-lg p-4 text-center hover:shadow-2xl transform hover:scale-110 transition-all duration-300 ease-out cursor-pointer relative">
            <div class="w-12 h-12 bg-blue-100 dark:bg-blue-900 rounded-lg mx-auto mb-2 flex items-center justify-center group-hover:rotate-12 transition-transform duration-300">
              <span class="text-blue-600 dark:text-blue-400 font-bold text-lg">V</span>
            </div>
            <p class="text-sm font-semibold text-gray-900 dark:text-white">Vite</p>
          ...
          <div class="tech-item group bg-white dark:bg-gray-800 rounded-lg shadow-lg p-4 text-center hover:shadow-2xl transform hover:scale-110 transition-all duration-300 ease-out cursor-pointer relative">
            <div class="w-12 h-12 bg-green-100 dark:bg-green-900 rounded-lg mx-auto mb-2 flex items-center justify-center group-hover:rotate-12 transition-transform duration-300">
              <span class="text-green-600 dark:text-green-400 font-bold text-lg">P</span>
            </div>
            <p class="text-sm font-semibold text-gray-900 dark:text-white">Python</p>
            <div class="tech-tooltip absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 bg-gray-900 text-white text-xs rounded py-1 px-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
              AI Service (FastAPI/Flask)
              <div class="absolute top-full left-1/2 transform -translate-x-1/2 w-0 h-0 border-l-4 border-r-4 border-t-4 border-transparent border-t-gray-900"></div>
            </div>
          </div>
          <div class="tech-item group bg-white dark:bg-gray-800 rounded-lg shadow-lg p-4 text-center hover:shadow-2xl transform hover:scale-110 transition-all duration-300 ease-out cursor-pointer relative">
            <div class="w-12 h-12 bg-yellow-100 dark:bg-yellow-900 rounded-lg mx-auto mb-2 flex items-center justify-center group-hover:rotate-12 transition-transform duration-300">
              <span class="text-yellow-600 dark:text-yellow-400 font-bold text-lg">TF</span>
            </div>
            <p class="text-sm font-semibold text-gray-900 dark:text-white">TensorFlow.js</p>
            <div class="tech-tooltip absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 bg-gray-900 text-white text-xs rounded py-1 px-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
              Face Detection
              <div class="absolute top-full left-1/2 transform -translate-x-1/2 w-0 h-0 border-l-4 border-r-4 border-t-4 border-transparent border-t-gray-900"></div>
            </div>
      ...
      <div class="mb-8 sm:mb-12 md:mb-20 mt-4 sm:mt-6 md:mt-8">
        <h2 class="text-xl sm:text-2xl font-bold mb-4 sm:mb-6 md:mb-8 text-center animate-fade-in-up px-2" style="animation-delay:3s;">By the Numbers</h2>
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 px-2">
          <div class="stat-card bg-white dark:bg-gray-800 rounded-lg shadow-lg p-4 sm:p-6 text-center hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-300 ease-out">
            <div class="w-12 h-12 sm:w-16 sm:h-16 bg-blue-100 dark:bg-blue-900 rounded-full mx-auto mb-3 sm:mb-4 flex items-center justify-center">
              <svg class="w-6 h-6 sm:w-8 sm:h-8 text-blue-600 dark:text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"/>
              </svg>
            </div>
            <div id="stat-total-visits" class="text-2xl sm:text-3xl font-bold text-blue-600 dark:text-blue-400 mb-2">0</div>
            <div class="text-sm sm:text-base text-gray-600 dark:text-gray-300">Total Visits</div>
          </div>
          <div class="stat-card bg-white dark:bg-gray-800 rounded-lg shadow-lg p-4 sm:p-6 text-center hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-300 ease-out">
            <div class="w-12 h-12 sm:w-16 sm:h-16 bg-green-100 dark:bg-green-900 rounded-full mx-auto mb-3 sm:mb-4 flex items-center justify-center">
              <svg class="w-6 h-6 sm:w-8 sm:h-8 text-green-600 dark:text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
              </svg>
            </div>
            <div id="stat-completed-today" class="text-2xl sm:text-3xl font-bold text-green-600 dark:text-green-400 mb-2">0</div>
            <div class="text-sm sm:text-base text-gray-600 dark:text-gray-300">Completed Today</div>
          </div>
          <div class="stat-card bg-white dark:bg-gray-800 rounded-lg shadow-lg p-4 sm:p-6 text-center hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-300 ease-out">
            <div class="w-12 h-12 sm:w-16 sm:h-16 bg-purple-100 dark:bg-purple-900 rounded-full mx-auto mb-3 sm:mb-4 flex items-center justify-center">
              <svg class="w-6 h-6 sm:w-8 sm:h-8 text-purple-600 dark:text-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/>
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"/>
              </svg>
            </div>
            <div id="stat-places" class="text-2xl sm:text-3xl font-bold text-purple-600 dark:text-purple-400 mb-2">0</div>
            <div class="text-sm sm:text-base text-gray-600 dark:text-gray-300">Visit Locations</div>
          </div>
          <div class="stat-card bg-white dark:bg-gray-800 rounded-lg shadow-lg p-4 sm:p-6 text-center hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-300 ease-out">
            <div class="w-12 h-12 sm:w-16 sm:h-16 bg-orange-100 dark:bg-orange-900 rounded-full mx-auto mb-3 sm:mb-4 flex items-center justify-center">
              <svg class="w-6 h-6 sm:w-8 sm:h-8 text-orange-600 dark:text-orange-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"/>
              </svg>
            </div>
            <div id="stat-success-rate" class="text-2xl sm:text-3xl font-bold text-orange-600 dark:text-orange-400 mb-2">0%</div>
            <div class="text-sm sm:text-base text-gray-600 dark:text-gray-300">Success Rate</div>
          </div>
        </div>
      </div>
      ...
      <div class="mb-8 sm:mb-12 md:mb-20 mt-4 sm:mt-6 md:mt-8">
        <h2 class="text-xl sm:text-2xl font-bold mb-4 sm:mb-6 md:mb-8 text-center animate-fade-in-up px-2" style="animation-delay:3.2s;">Our Culture</h2>
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 px-2">
          <div class="culture-card group bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-300 ease-out cursor-pointer">
            <div class="h-32 sm:h-40 md:h-48 bg-gradient-to-br from-blue-400 to-blue-600 flex items-center justify-center">
              <svg class="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"/>
              </svg>
            </div>
            <div class="p-4 sm:p-6">
              <h3 class="text-base sm:text-lg font-semibold text-gray-900 dark:text-white mb-2 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors duration-300">Team Building</h3>
              <p class="text-xs sm:text-sm text-gray-600 dark:text-gray-300">Regular team activities and events to build strong relationships.</p>
            </div>
          </div>
          <div class="culture-card group bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-300 ease-out cursor-pointer">
            <div class="h-32 sm:h-40 md:h-48 bg-gradient-to-br from-green-400 to-green-600 flex items-center justify-center">
              <svg class="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.746 0 3.332.477 4.5 1.253v13C19.832 18.477 18.246 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"/>
              </svg>
            </div>
            <div class="p-4 sm:p-6">
              <h3 class="text-base sm:text-lg font-semibold text-gray-900 dark:text-white mb-2 group-hover:text-green-600 dark:group-hover:text-green-400 transition-colors duration-300">Learning & Development</h3>
              <p class="text-xs sm:text-sm text-gray-600 dark:text-gray-300">Continuous learning opportunities and professional development programs.</p>
            </div>
          </div>
          <div class="culture-card group bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-300 ease-out cursor-pointer">
            <div class="h-32 sm:h-40 md:h-48 bg-gradient-to-br from-purple-400 to-purple-600 flex items-center justify-center">
              <svg class="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"/>
              </svg>
            </div>
            <div class="p-4 sm:p-6">
              <h3 class="text-base sm:text-lg font-semibold text-gray-900 dark:text-white mb-2 group-hover:text-purple-600 dark:group-hover:text-purple-400 transition-colors duration-300">Work-Life Balance</h3>
              <p class="text-xs sm:text-sm text-gray-600 dark:text-gray-300">Flexible working arrangements and wellness programs for all employees.</p>
            </div>
          </div>
        </div>
      </div>
