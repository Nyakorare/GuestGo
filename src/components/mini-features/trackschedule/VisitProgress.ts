export function VisitProgress() {
  return `
    <div class="mb-8">
      ...
      <div class="bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-700 dark:to-gray-800 rounded-xl p-6 border-2 border-gray-300 dark:border-gray-600 shadow-lg">
