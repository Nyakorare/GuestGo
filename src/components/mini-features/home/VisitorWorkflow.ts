...
export function VisitorWorkflow() {
  return {
    steps: `
      <button class="rounded-lg px-3 py-2 text-sm bg-blue-600 text-white" data-workflow-step="1">1. Appointment</button>
    ...
    panels: `
      <div class="rounded-lg border border-gray-200 dark:border-gray-700 p-4 bg-white dark:bg-gray-800" data-workflow-panel="1">
        <p class="font-semibold mb-1">Book an Appointment</p>
      ...
      <div class="rounded-lg border border-gray-200 dark:border-gray-700 p-4 bg-white dark:bg-gray-800 hidden" data-workflow-panel="2">
        <p class="font-semibold mb-1">Go to Your Appointment Date</p>
        <p class="text-sm text-gray-600 dark:text-gray-400">On your appointment date, you can enter through the guard for entrance verification, or access the dashboard and scan an entrance gate to proceed with your visit.</p>
      </div>
      ...
      <div class="rounded-lg border border-gray-200 dark:border-gray-700 p-4 bg-white dark:bg-gray-800 hidden" data-workflow-panel="4">
        <p class="font-semibold mb-1">Go to Your Appointment Place</p>
        <p class="text-sm text-gray-600 dark:text-gray-400">Proceed to your appointment place and have your QR code scanned by the personnel. This confirms your arrival at your intended destination.</p>
      </div>
      <div class="rounded-lg border border-gray-200 dark:border-gray-700 p-4 bg-white dark:bg-gray-800 hidden" data-workflow-panel="5">
        ...
        <p class="text-sm text-gray-600 dark:text-gray-400">When leaving, go to an exit gate that has an exit scan. Verify your face using the face data saved from your entrance. Once verified, your appointment will be completed.</p>
      </div>
    `
  };
}
