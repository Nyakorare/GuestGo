...
function createTermsOfServiceModal() {
  ...
  modal.innerHTML = `
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-4 sm:p-6 md:p-8 max-w-4xl w-full mx-4 mt-4 sm:mt-8 relative transform scale-75 opacity-0 transition-all duration-500 ease-out border border-gray-200 dark:border-gray-700 overflow-hidden">
      <!-- Decorative gradient background -->
      <div class="absolute top-0 left-0 right-0 h-2 bg-gradient-to-r from-purple-500 via-pink-500 to-indigo-500"></div>
      
      <!-- Close button -->
      <button onclick="closeTermsOfServiceModal()" class="modal-close-btn absolute top-4 right-4 text-gray-400 hover:text-red-500 text-3xl font-light z-10 w-10 h-10 flex items-center justify-center rounded-full hover:bg-gray-100 dark:hover:bg-gray-700 transition-all duration-300">&times;</button>
      ...
      <div class="flex items-center justify-between mb-6 pt-2">
        <div class="flex items-center gap-3">
          ...
          <div>
            <h3 class="text-3xl font-bold gradient-text typing-title" data-text="Terms of Service">Terms of Service</h3>
            <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Last updated: ${new Date().toLocaleDateString()}</p>
          </div>
        </div>
      </div>
      ...
      <div class="policy-scroll max-h-[70vh] overflow-y-auto pr-2 policy-content-wrapper">
        <div class="space-y-6 text-sm text-gray-700 dark:text-gray-300">
          ...
          <section class="policy-section" data-section="1">
            ...
            <p class="mb-3 leading-relaxed">Permission is granted to temporarily use GuestGo for personal and business purposes. This license does not include:</p>
            <ul class="list-none ml-2 mb-3 space-y-2">
              <li class="policy-list-item flex items-start gap-2">
                <span class="text-purple-500 mt-1">▸</span>
              ...
              <li class="policy-list-item flex items-start gap-2">
                <span class="text-purple-500 mt-1">▸</span>
                <span>Using the materials for any commercial purpose without explicit permission</span>
              </li>
              <li class="policy-list-item flex items-start gap-2">
                <span class="text-purple-500 mt-1">▸</span>
                <span>Attempting to reverse engineer or decompile any software</span>
              </li>
              <li class="policy-list-item flex items-start gap-2">
                <span class="text-purple-500 mt-1">▸</span>
          ...
          <section class="policy-section" data-section="2">
            ...
            <p class="mb-3 leading-relaxed">As a user of GuestGo, you agree to:</p>
            <ul class="list-none ml-2 mb-3 space-y-2">
              <li class="policy-list-item flex items-start gap-2">
                <span class="text-pink-500 mt-1">▸</span>
                <span>Provide accurate and complete information when scheduling visits</span>
              </li>
              <li class="policy-list-item flex items-start gap-2">
                <span class="text-pink-500 mt-1">▸</span>
              ...
              <li class="policy-list-item flex items-start gap-2">
                <span class="text-pink-500 mt-1">▸</span>
                <span>Follow all security protocols and guidelines</span>
              </li>
              <li class="policy-list-item flex items-start gap-2">
                <span class="text-pink-500 mt-1">▸</span>
                <span>Respect the maximum visit limits (2 visits per week per user account)</span>
              </li>
              <li class="policy-list-item flex items-start gap-2">
                <span class="text-pink-500 mt-1">▸</span>
                <span>Notify us at least 24 hours in advance if you need to reschedule</span>
              </li>
              <li class="policy-list-item flex items-start gap-2">
                <span class="text-pink-500 mt-1">▸</span>
                <span>Bring valid identification for verification purposes</span>
              </li>
            </ul>
          </section>
          ...
          <section class="policy-section" data-section="4">
            <h4 class="text-xl font-bold text-gray-900 dark:text-white mb-3 section-header flex items-center gap-2">
              <span class="w-2 h-2 rounded-full bg-cyan-500"></span>
              <span>5. Security and Verification</span>
            </h4>
            <p class="mb-3 leading-relaxed">
          ...
          <section class="policy-section" data-section="5">
            ...
            <p class="mb-3 leading-relaxed">You agree not to:</p>
            <ul class="list-none ml-2 mb-3 space-y-2">
              <li class="policy-list-item flex items-start gap-2">
                <span class="text-teal-500 mt-1">▸</span>
              ...
              <li class="policy-list-item flex items-start gap-2">
                <span class="text-teal-500 mt-1">▸</span>
                <span>Attempt to gain unauthorized access to the system</span>
              </li>
              <li class="policy-list-item flex items-start gap-2">
                <span class="text-teal-500 mt-1">▸</span>
              ...
              <li class="policy-list-item flex items-start gap-2">
                <span class="text-teal-500 mt-1">▸</span>
                <span>Use automated systems to schedule visits</span>
              </li>
              <li class="policy-list-item flex items-start gap-2">
                <span class="text-teal-500 mt-1">▸</span>
          ...
          <section class="policy-section" data-section="8">
            <h4 class="text-xl font-bold text-gray-900 dark:text-white mb-3 section-header flex items-center gap-2">
          ...
          <section class="policy-section" data-section="9">
            <h4 class="text-xl font-bold text-gray-900 dark:text-white mb-3 section-header flex items-center gap-2">
            ...
            <div class="bg-gradient-to-r from-purple-50 to-pink-50 dark:from-gray-700 dark:to-gray-600 rounded-lg p-4 space-y-2">
              <p class="mb-1 flex items-center gap-2">
                <svg class="w-5 h-5 text-purple-600 dark:text-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
                </svg>
                <a href="mailto:support@guestgo.com" class="text-purple-600 dark:text-purple-400 hover:underline font-medium">support@guestgo.com</a>
              </p>
              <p class="mb-1 flex items-center gap-2">
                <svg class="w-5 h-5 text-purple-600 dark:text-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path>
                </svg>
                <a href="tel:+639123456789" class="text-purple-600 dark:text-purple-400 hover:underline font-medium">+63 912 345 6789</a>
              </p>
            </div>
          </section>
        </div>
      ...
      <div class="mt-6 flex justify-end gap-3 pt-4 border-t border-gray-200 dark:border-gray-700">
        <button 
          ...
          class="inline-flex justify-center items-center gap-2 rounded-lg border border-transparent shadow-sm px-6 py-2.5 bg-gradient-to-r from-purple-600 to-pink-600 text-base font-medium text-white hover:from-purple-700 hover:to-pink-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 sm:text-sm transition-all duration-300 transform hover:scale-105"
        >
          <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path>
          </svg>
...
export function setupLegalModals(): void {
  ...
  function openModal(modal: HTMLElement) {
    ...
    setTimeout(() => {
      ...
      // Animate typing effect for title (both legal modals)
      const titleElement = modal.querySelector('.typing-title') as HTMLElement;
      if (titleElement) {
        const titleText = titleElement.getAttribute('data-text') || titleElement.textContent || (modal.id === 'privacyPolicyModal' ? 'Privacy Policy' : 'Terms of Service');
        setTimeout(() => {
  ...
  function closeModal(modal: HTMLElement) {
    ...
    setTimeout(() => {
      ...
      if (titleElement) {
        ...
        titleElement.textContent = titleElement.getAttribute('data-text') || (modal.id === 'privacyPolicyModal' ? 'Privacy Policy' : 'Terms of Service');
      }
    }, 500);
  }
