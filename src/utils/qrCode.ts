    ...
    <body>
      ...
      <div class="visit-card">
        ...
        <div class="qr-section">
          <div class="qr-code" onclick="openQRZoom('${qrCodeDataUrl}')">
            <img src="${qrCodeDataUrl}" alt="Visit QR Code">
            <div class="qr-magnifier">
          ...
          <p style="margin: 0; color: #6b7280; font-size: 12px;">
            Click to zoom • Scan this QR code to view visit details
          </p>
        </div>
        
        <!-- QR Code Zoom Modal -->
        <div id="qrZoomModal" class="qr-zoom-modal" onclick="closeQRZoom()">
          <div class="qr-zoom-content" onclick="event.stopPropagation()">
            <button class="qr-zoom-close" onclick="closeQRZoom()">×</button>
            <img id="qrZoomImage" src="" alt="Zoomed QR Code">
          </div>
        </div>
      ...
      <script>
        ...
        function openQRZoom(qrCodeUrl) {
          const modal = document.getElementById('qrZoomModal');
          const image = document.getElementById('qrZoomImage');
          if (modal && image) {
            image.src = qrCodeUrl;
    ...
    <body>
      ...
      <div class="gate-card">
        ...
        <div class="qr-section">
          ...
          <p style="margin: 0; color: #6b7280; font-size: 12px;">
            Click to zoom • Scan this QR code to view gate details
          </p>
        </div>
